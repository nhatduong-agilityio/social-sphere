  ...
  LATEST_NEWS_FEED_IDS_BY_AUTHOR_ID: (
    ...
    const filters =
      context === NewsFeedsContext.PERSONAL
        ...
        : `filters[$or][0][$and][0][author][id][$eq]=${authorId}&filters[$or][0][$and][1][shareType][$eq]=yourFeed&filters[$or][2][$and][0][author][followerRelationships][followed][id][$eq]=${authorId}&filters[$or][2][$and][1][author][followerRelationships][requestStatus][$eq]=friends&fields[0]=id&sort[createdAt]=desc&pagination[page]=${page}&pagination[pageSize]=${pageSize}`;
