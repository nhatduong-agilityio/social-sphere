...
export const ShareDropdown = memo(
  ({ options, selectedOption, onSelectedOption }: ShareDropdownProps) => {
      ...
      <DropdownMenu onOpenChange={setOpen}>
        <DropdownMenuTrigger asChild>
          ...
          >
            <span
              className={cn(
                'flex gap-1 leading-[21px] [&>svg]:w-5 [&>svg]:h-5 [&>svg]:text-neutral-700 [&>svg]:dark:text-white [&>svg]:transition-colors [&>svg]:duration-200',
