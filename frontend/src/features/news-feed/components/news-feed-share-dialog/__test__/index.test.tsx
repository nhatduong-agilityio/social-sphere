...
import { SHARE_OPTIONS } from '@/features/news-feed/constants/share-news-feed';
...
jest.mock('@/components/sections/compose-activity-preview', () => ({
...
jest.mock('@/components/sections/tag-friends', () => ({
